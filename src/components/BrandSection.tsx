          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            >
              ...
              <div
                ...
                style={{ opacity: 0 }}
              >
                <p className="font-sans text-base sm:text-[18px] leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
                  You've already done the difficult work — building an audience
                  that trusts you.
                </p>
                <p className="font-sans text-base sm:text-[18px] leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
                  Now build a platform worthy of that trust. One that bears your
                  name, your aesthetic, and your vision — independent from
                  every platform that doesn't.
                </p>
              </div>
            ...
            >
              <div className="w-full max-w-[580px] relative">
                ...
                <div
                  ...
                  style={{ background: 'rgba(212, 175, 110, 0.06)', mixBlendMode: 'screen' }}
                  aria-hidden="true"
                />
                <img
